...
package com.fastaccount.util.wheel;
...
import com.fastaccount.util.DensityUtil;
...
public class WheelView extends View {
     ...
     */
    public static int VALUE_TEXT_COLOR = 0xe04d4a4d;
    /**
     * Items text color
     */
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int offset = getItemHeight() / 2 + DensityUtil.dip2px(context, 5);
